  ...
  return (
    <div className="border rounded-md overflow-hidden">
      ...
      {emails.length === 0 ? (
        ...
        <>
          {/* Table header */}
          <div className="hidden sm:grid grid-cols-[1fr_2fr_auto] gap-4 px-4 py-2 text-xs font-medium text-muted-foreground uppercase tracking-wide border-b bg-muted/10">
          ...
          <ul>
            {emails.map((email) => (
              <React.Fragment key={email.id}>
                <li
                  className={`grid sm:grid-cols-[1fr_2fr_auto] gap-2 sm:gap-4 items-center px-4 py-3 cursor-pointer border-b last:border-b-0 transition-colors hover:bg-muted/30 ${
